...
const W={
 bFull:{warm:['local:inchworm','local:squat','local:reverse_lunge','local:dead_bug'],prep:['local:split_squat','local:push_up','local:dumbbell_row','local:single_leg_glute_bridge'],main:['local:kettlebell_goblet_squat','local:dumbbell_row','local:dumbbell_romanian_deadlift','local:push_up','local:suitcase_carry'],finish:['local:mountain_climber','local:reverse_lunge','local:plank_shoulder_tap']},
 bStrength:{warm:['local:inchworm','local:squat','local:split_squat','local:dead_bug'],prep:['local:dumbbell_goblet_squat','local:dumbbell_row','local:push_up','local:single_leg_glute_bridge'],main:['local:dumbbell_split_squat','local:dumbbell_romanian_deadlift','local:dumbbell_bench_press','local:dumbbell_row','local:farmer_carry'],finish:['local:suitcase_carry','local:split_squat','local:plank']},
 bConditioning:{warm:['local:inchworm','local:squat','local:reverse_lunge','local:plank'],prep:['local:kettlebell_goblet_squat','local:push_up','local:mountain_climber','local:dead_bug'],main:['local:kettlebell_swing','local:squat_to_press','local:walking_lunge','local:bear_crawl','local:farmer_carry'],finish:['local:battle_rope_waves','local:burpee','local:plank_shoulder_tap']},
 bHybrid:{warm:['local:inchworm','local:lateral_lunge','local:squat','local:dead_bug'],prep:['local:dumbbell_goblet_squat','local:dumbbell_row','local:push_up','local:split_squat'],main:['local:dumbbell_step_up','local:dumbbell_row','local:kettlebell_deadlift','local:dumbbell_shoulder_press','local:suitcase_carry'],finish:['local:kettlebell_swing','local:mountain_climber','local:reverse_lunge']},
 aFull:{warm:['local:inchworm','local:lateral_lunge','local:overhead_squat','local:plank_shoulder_tap'],prep:['local:front_squat','local:bent_over_row','local:push_press','local:deadlift'],main:['local:hang_power_clean','local:front_squat','local:renegade_row','local:push_press','local:dumbbell_snatch'],finish:['local:kettlebell_swing','local:burpee','local:dumbbell_thruster']},
 aStrength:{warm:['local:inchworm','local:split_squat','local:overhead_squat','local:dead_bug'],prep:['local:back_squat','local:deadlift','local:bent_over_row','local:overhead_press'],main:['local:front_squat','local:romanian_deadlift','local:bent_over_row','local:push_press','local:dumbbell_bulgarian_split_squat'],finish:['local:farmer_carry','local:dumbbell_thruster','local:kettlebell_swing']},
 aConditioning:{warm:['local:inchworm','local:lateral_lunge','local:squat','local:plank_shoulder_tap'],prep:['local:kettlebell_swing','local:dumbbell_thruster','local:push_up','local:reverse_lunge'],main:['local:dumbbell_clean_press','local:kettlebell_swing','local:dumbbell_snatch','local:burpee','local:renegade_row'],finish:['local:battle_rope_slam','local:mountain_climber','local:dumbbell_thruster']},
 aHybrid:{warm:['local:inchworm','local:overhead_squat','local:split_squat','local:side_plank'],prep:['local:deadlift','local:push_press','local:bent_over_row','local:kettlebell_swing'],main:['local:clean_and_press','local:dumbbell_bulgarian_split_squat','local:renegade_row','local:kettlebell_clean_press','local:dumbbell_snatch'],finish:['local:burpee','local:battle_rope_waves','local:dumbbell_snatch']}
};
const specs=[
...
export const programs=specs.map(([id,title,level,type,equipment,set,ratio])=>make({id,title,subtitle:`Weekly refresh · 60 λεπτά ${type} με νέα ακολουθία, stimulus και πυκνότητα.`,level,type,methodology:type,equipment,focus:type,week:'2026-09-26'},weeklySession({...set,level,mainRatio:ratio})));
